...
public class MainViewController implements Initializable {
    ...
    public void onMenuItemDepartmentAction() {
        loadView("/org/example/workshopjavafxjdbc/gui/DepartmentList.fxml", (DepartmentListController controller) -> {
    ...
    public void onMenuItemAboutAction() {
        loadView("/org/example/workshopjavafxjdbc/gui/About.fxml", x -> {});
    }
